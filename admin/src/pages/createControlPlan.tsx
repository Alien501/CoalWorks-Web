            ...
            fields: [
                {
                    id: uuidv4(),
                    type: 'text',
                    label: 'Description of the control Plan',
                    required: true,
        ...
        return (
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-semibold">Create your control plan</h2>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            {['text', 'number', 'select', 'checkbox', 'textarea', 'date', 'image'].map(type => (
                ...
                <div className="flex justify-between">
                    ...
                    <Button onClick={onSaveTemplateButtonClicked}>Create control plan</Button>
                </div>
            </div>
        )
    }
