...
import { SubmitDetailDialog } from '../submitDetailsDialog';
...
//@ts-ignore
function OperationsAndProduction({ title, sections, setRegisterData, registerData }) {
    ...
    <div className='h-full'>
      <div className="space-y-6 p-6 border rounded-lg w-full h-full overflow-y-auto">
        ...
        <div className="space-y-4">
          {stepper.switch({
            production: () => <ProductionAndCost setRegisterData={setRegisterData} registerData={registerData} setIsSubmitted={setIsSubmitted} />,
            workforce: () => <WrokForce setRegisterData={setRegisterData} registerData={registerData} setIsSubmitted={setIsSubmitted} />,
