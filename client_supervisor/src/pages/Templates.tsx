...
import TemplatesTable from "@/components/custom/templatesTable";
import { Button } from "@/components/ui/button";
const Templates = () => {
    return (
        <div id="Archives-wrapper" className=" font-poppins">
            <div className="flex justify-between items-center border-b h-12">
                <div className="pl-2 font-semibold">Templates</div>
                <div className="flex space-x-2 justify-center items-center">
                    <div className="h-full text-sm">39 Templates</div>
