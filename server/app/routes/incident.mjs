...
export const incidents = express.Router();

incidents.post("/createIncident", async (req, res) => {
...
incidents.put("/:incident_id", async (req, res) => {
...
incidents.get("/:incident_id", async (req, res) => {
    const { incident_id } = req.params;
    try {
